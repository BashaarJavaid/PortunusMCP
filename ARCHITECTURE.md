...
- **Adversarial suite (this is your differentiator in interviews):**
  ...
  - Inject Redis execute and pointer-deletion failures after a committed audit insert, then assert the next writer rebuilds from PostgreSQL and the full CLI verifier still accepts the chain.
